<form action="/controllers/insert_actors.php" method="POST" class="flex flex-col items-center bg-slate-200 border-2 border-slate-800 rounded">
    <div class="flex flex-row">
        <div class="flex flex-col gap-y-8 p-10">
            ...
            <label for="birthday" class="px-10">Fecha de nacimiento</label>
        </div>
        <div class="flex flex-col gap-y-8 p-10">
            ...
            <input id="birthday" name="birthday" type="date" required class="rounded">
        </div>
    </div>
